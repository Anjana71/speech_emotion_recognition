...
# Load data and apply label mapping
# Data Preparation
def prepare_data(features_csv):
    ...
    return X, y, encoder  # Return encoder for class names


# Evaluate the model
# Evaluate Model
def evaluate_model(model_path, features_csv):
    X, y, encoder = prepare_data(features_csv)
    ...
    # Fixed encoder reference for class names
    #print("\n📊 Classification Report:\n", classification_report(y_true, y_pred, target_names=encoder.classes_))

# Run evaluation
if __name__ == "__main__":
    model_path = "models/lstm_gru_0.9740.h5"  # Change this if the model name differs
    features_csv = "data/features/extracted_features.csv"
    evaluate_model(model_path, features_csv)'''
